...
<!-- Form -->
        <h2 style="text-align: center; margin-top: 40px;  font-family: 'Fredoka One', cursive;">Transaction</h2>
            <?php
                include 'config.php';
                $sid=$_GET['id'];
            ...
            <form class="contact" method="post">
                ...
                <input type="text" name="Name" value="<?php echo $rows['name']; ?>" readonly><br>

                <label>Balance:</label><br/>
                <input type="text" name="balance" value="<?php echo $rows['balance']; ?>" readonly >
                <br>
                <label>Tranfer to:</label><br/>
                ...
                <input type="submit" class="hero-button" name="submit" value="Transfer"><br/>
            </form>
            </div>
<!--End of Form-->
